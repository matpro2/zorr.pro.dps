const petals = [
    ...
    { 
        ...
        specials: [
            { 
                ...
                tierRestricted: true,
                stats: "tier",
                affectedByClover: true,
                chance: 0.5
            }
        ] 
    },
    { 
        name: "Dice", stack: true, 
    ...
    { name: "Golden Palm Leaf", stack: true, entity: 1, reload: 1.5, health: 20, damage: 20, armor: 0,
        specials: [
            { type: "secondaryReloadFactor", 
              global: true,
              value: {
                    0: 1.5, 1: 2.25, 2: 3, 3: 4.5, 4: 6, 5: 7.5, 6: 10, 7: 20, 8: 35, 9: 75 
                } 
            },
        ]
    },
    ...
    { 
        ...
        specials: [
            { 
                ...
                target: "Pet",
                stats: "Damage", 
                value: { 0: 7.5, 1: 8.45, 2: 11.3, 3: 16.05, 4: 22.7, 5: 31.25, 6: 41.7, 7: 54.05, 8: 68.3, 9: 84.85 }
            }
        ] 
    },
    { 
        name: "Iris", stack: true, 
        entity: 1, reload: 2.0, health: 5, damage: 5, armor: 0,
        special: { type: "Poison", duration: 3, damage: 40, stack: false }
    },
    { name: "Leaf", stack: true, entity: 1, reload: 1.0, health: 12, damage: 15, armor: 0 },
    { name: "Magic Leaf", stack: true, entity: 1, reload: 1.0, health: 12, damage: 15, armor: 0,
        special: { type: "Magic", regen: 4 }
    },
    { name: "Magic Yuan", stack: true, entity: 1, reload: 0.75, health: 15, damage: 35, armor: 0,
        special: { type: "Magic", cost: 0.4 }
    },
    { name: "Magic Topaz", stack: true, entity: 1, reload: 0.75, health: 6, damage: 6, armor: 0,
        special: { type: "Magic", drain: 2, petArmor: 3.5 }
    },
    { 
        name: "Opal", 
        stack: false,
    ...
    { name: "Zodiac", stack: true, entity: 1, reload: 2.0, health: 100, damage: 200, armor: 5,
        specials: [
            { type: "reloadFactor", 
              global: true,
              value: {
                    0: -5, 1: -6.8, 2: -8.6, 3: -10.4, 4: -12.2, 5: -14, 6: -15.8, 7: -17.6, 8: -19.4, 9: -21.2 
                } 
            },
